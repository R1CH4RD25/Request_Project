...
def test_can_vehicle_be_assigned():
    ...
    request, approval = make_requests(1004, 101, "03/29/2023")
...
def test_can_vehicle_be_assigned_with_multiple_already_assigned():
    ...
    approval = model.Approval(1006, "Approved", 101, 1004, "Drive Safe")

    assert model.assign(request,approval, [assign1, assign2, assign3]) == True